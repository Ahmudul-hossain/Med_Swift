                ...
                children: [
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                        setState(() => isDonor = true);
                        Navigator.push(context, MaterialPageRoute(builder: (_) => const DonorRegistrationPage()));
                      },
                      child: Container(
                        padding: const EdgeInsets.symmetric(horizontal: 40, vertical: 16),
                        decoration: BoxDecoration(
                          color: isDonor ? const Color(0xFFFF8080) : Colors.white,
                          borderRadius: BorderRadius.circular(14),
                          border: Border.all(color: isDonor ? const Color(0xFFFF8080) : Colors.grey.shade300),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(Icons.volunteer_activism_rounded, color: isDonor ? Colors.white : const Color(0xFFFF8080), size: 20),
                            const SizedBox(width: 8),
                            Text('Yes, I am!', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: isDonor ? Colors.white : Colors.grey[700])),
                          ],
                        ),
                      ),
                    ),
